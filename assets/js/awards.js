...
let rightArrow = document.querySelector("#carousel-2 .right-arrow");
let leftArrow = document.querySelector("#carousel-2 .left-arrow");
//List of all of the screens in carousel
let screenStore = document.querySelectorAll("#carousel-2 .carousel-screen");
let numOfScreens = screenStore.length;
//List of all the circle stores
let circleStore = document.querySelectorAll("#carousel-2 .circle-container .circle");
