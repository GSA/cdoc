                ...
                <div class="grid-container">
                    <div class="grid-gap-banner">
                            <div class="usa-hero__callout " style="background: #cfe8ff; border-radius: 0.5rem; opacity: 0.9; margin-top: 10px; box-shadow: 0 1rem 2rem 0 rgb(0 0 0 / 40%); max-width: 20rem;">
                                ...
                                <p class="text-gray-70 font-sans-md text-bold">Kimberly Lewis and Yolanda Cooper, FERC (Non-CFO)</p>
                                <center>&</center> 
                                <p class="text-gray-70 font-sans-md text-bold"> Brian McKeon, DOS (CFO)</p>
                            </div>
                    </div>
                </div>
            </section>
