    ...
    <section class="usa-layout-docs__main">
        <div class="tablet:grid-col-12 line-height-sans-5 tablet:margin-y-10 margin-bottom-8">
            <section class="usa-accordion usa-accordion--bordered" aria-multiselectable="true">
                ...
                <h3 class="usa-accordion__heading"><button class="usa-accordion__button bg-accent-cool-lighter" aria-expanded="false" aria-controls="m-a5"><img src="{{site.baseurl}}/assets/images/icons/ribbon-outline.svg" class="workinggroup__accordion-icon" alt="">2021 CDOC Award Winners</button></h3>
