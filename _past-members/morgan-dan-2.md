...
full-role: Data Culture for the Workforce Working Group Lead
...
As the CDO, Dan had the overall responsibility for the DOT data program and data compliance across the department. He was responsible for establishing a clear vision of the data managed in DOT and the application of DOT data for decision-making. He served as the data strategist and adviser, steward for improving data quality, liaison for data sharing, and developer of new data products.
